...
let s:yellow     = '#fba922'
let s:blue       = '#3971ed'
let s:dark_blue  = '#3971ed'
let s:magenta    = '#a36ac7'
let s:violet     = '#a36ac7'
let s:cyan       = '#24c1e0'
let s:dark_cyan  = '#24c1e0'
let s:white      = '#ffffff'

let s:green_alt  = '#198844'

let s:bg             = '#1d1f21'
let s:bg_alt         = '#333537'
let s:bg_highlight   = '#333537'
let s:bg_popup       = '#4a4b4d'
...
let s:diff_info_bg0 = color#Mix('#d7e2fb', s:bg, 0.6)
let s:diff_info_bg1 = color#Mix('#d7e2fb', s:bg, 0.8)

let s:diff_add_fg  = s:green
let s:diff_add_fg0 = color#Mix(s:green,   s:fg, 0.4)
let s:diff_add_bg0 = color#Mix('#115d2e', s:bg, 0.4)
let s:diff_add_bg1 = color#Mix('#badbc6', s:bg, 0.6)
let s:diff_add_bg2 = color#Mix('#badbc6', s:bg, 0.8)

let s:gh_danger_fg  = s:red
let s:gh_danger_fg0 = color#Mix(s:red,     s:fg, 0.6)
let s:gh_danger_bg0 = color#Mix('#eaadaa', s:bg, 0.6)
let s:gh_danger_bg1 = color#Mix('#eaadaa', s:bg, 0.8)
let s:gh_danger_bg2 = color#Mix('#eaadaa', s:bg, 0.9)
...
call s:_('PmenuThumb',   '#4a4b3d',         '#4a4b3d')
...
call s:_('Regexp',               '#c76abd', 'none',        'none')
call s:_('RegexpSpecial',        '#9f5497', 'none',        'none')
call s:_('RegexpDelimiter',      '#513563', 'none',        'bold')
call s:_('RegexpKey',            '#4f2a4b', 'none',        'bold')
...
call s:_('DapCurrentLine',        '',       '#64430d', '')
call s:_('DapCurrentLineNum',     s:yellow, '#966514', 'bold')
call s:_('DapBreakpointNum',      s:red,    '',        'bold')
call s:_('DapLogpointNum',        s:orange, '',        'bold')


call s:_('DbgCurrent',           '#d7e2fb', '#3971ed', '')
call s:_('DbgBreakPt',           '',        '#a36ac7', '')
